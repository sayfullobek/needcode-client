...
import { SOURCE_CODE_HEAD } from '../../../utils/TableHeadUtils'
...
export const SourceCode = () => {
	...
	const exportToExcel = () => {
		...
		XLSX.utils.book_append_sheet(workbook, worksheet, 'sourceCodeData')
		...
		saveAs(dataBlob, 'source-code-data.xlsx')
	}
	...
	return loading ? (
		<Box sx={{ padding: '3rem' }}>
			<Breadcrump
				status={'add'}
				url={`/${DASHBOARD_URL.sourceCodeAdd}`}
			...
			<AutoTable
				...
				fields={SOURCE_CODE_HEAD}
				url={DASHBOARD_URL.sourceCodeUpdate}
				deleteUrl={APP_API.sourceCode}
				getAll={getAll}
				pathName={pathName}
			/>
